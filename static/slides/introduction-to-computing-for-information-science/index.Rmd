...
```{r jeri}
include_graphics(path = "/Users/jeanclipperton/Library/CloudStorage/Box-Box/Teaching/CFSS/course-site/static/img/stock-photos/000022.jpg", error = FALSE)
```
...
```{r ryan}
include_graphics(path = "/Users/jeanclipperton/Library/CloudStorage/Box-Box/Teaching/CFSS/course-site/static/img/stock-photos/000284.jpg", error = FALSE)
```
...
```{r fernando}
include_graphics(path = "/Users/jeanclipperton/Library/CloudStorage/Box-Box/Teaching/CFSS/course-site/static/img/stock-photos/000232.jpg", error = FALSE)
```
...
```{r fang}
include_graphics(path = "/Users/jeanclipperton/Library/CloudStorage/Box-Box/Teaching/CFSS/course-site/static/img/stock-photos/000251.jpg", error = FALSE)
```
