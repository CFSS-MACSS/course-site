...
```{r echo=FALSE, fig.cap="Histogram of most frequent words in Taylor Swift songs", out.width = '40%', dpi = 300}
...
```{r echo=FALSE, fig.cap="Histogram of most frequent words in Taylor Swift songs by album", out.width = '40%', dpi = 300}
...
```{r echo=FALSE, fig.cap="Frequent words in a two-topic model", out.width = '70%', dpi = 300}
...
# Back to TS
![](https://tenor.com/view/matin%C3%A9e-inthevault-gif-23143928)
